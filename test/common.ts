...
if (!fs.lstatSync(TEST_DATA_DIR).isDirectory()) {
  throw new Error(
    "The path read from environment variable " +
      "AAS_CORE3_0_RC02_TYPESCRIPT_TEST_DATA_DIR is not a directory: " +
      TEST_DATA_DIR
  );
}
