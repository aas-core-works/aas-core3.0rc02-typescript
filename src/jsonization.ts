...
class SetterForExtension {
  ...
  refersTo: AasTypes.Reference | null = null;
  ...
  setRefersToFromJsonable(jsonable: JsonValue): DeserializationError | null {
    ...
    if (parsedOrError.error !== null) {
      ...
      this.refersTo = parsedOrError.mustValue();
      return null;
    }
  }
}
 ...
 * of {@link types!ModelingKind}.
 *
 * @param jsonable - to be parsed
 * @returns parsed literal, or an error if `jsonable` invalid
 */
export function modelingKindFromJsonable(
  jsonable: JsonValue
): AasCommon.Either<AasTypes.ModelingKind, DeserializationError> {
  if (typeof jsonable !== "string") {
    return newDeserializationError<AasTypes.ModelingKind>(
      `Expected a string, but got: ${typeof jsonable}`
    );
  }

  const literal = AasStringification.modelingKindFromString(jsonable);
  if (literal === null) {
    return newDeserializationError<AasTypes.ModelingKind>(
      "Not a valid string representation of " + `a literal of ModelingKind: ${jsonable}`
    );
  }

  return new AasCommon.Either<AasTypes.ModelingKind, DeserializationError>(
    literal,
    null
  );
}
...
class SetterForAssetAdministrationShell {
  ...
  displayName: Array<AasTypes.LangString> | null = null;

  description: Array<AasTypes.LangString> | null = null;
  ...
  setDisplayNameFromJsonable(jsonable: JsonValue): DeserializationError | null {
    ...
    const items = new Array<AasTypes.LangString>();

    let i = 0;
    for (const jsonableItem of iterable) {
      const itemOrError = langStringFromJsonable(jsonableItem);
  ...
  /**
   * Parse `jsonable` as the value of {@link checksum}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setChecksumFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.checksum = parsedOrError.mustValue();
      return null;
    }
  }
...
class SetterForAssetInformation {
  ...
  globalAssetId: AasTypes.Reference | null = null;
...
export function specificAssetIdFromJsonable(
  ...
  if (setter.externalSubjectId === null) {
    return newDeserializationError<AasTypes.SpecificAssetId>(
      "The required property 'externalSubjectId' is missing"
    );
  }
...
class SetterForSubmodel {
  ...
  kind: AasTypes.ModelingKind | null = null;
   ...
   */
  setKindFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = modelingKindFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.kind = parsedOrError.mustValue();
...
class SetterForMultiLanguageProperty {
  ...
  value: Array<AasTypes.LangString> | null = null;
...
class SetterForEntity {
  ...
  specificAssetId: AasTypes.SpecificAssetId | null = null;
  ...
  /**
   * Parse `jsonable` as the value of {@link specificAssetId}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setSpecificAssetIdFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = specificAssetIdFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.specificAssetId = parsedOrError.mustValue();
      return null;
    }
  }
}
...
/**
 * Provide de-serialize & set methods for properties
 * of {@link types!LangString}.
 */
class SetterForLangString {
...
/**
 * Parse an instance of {@link types!LangString} from the JSON-able
 * structure `jsonable`.
 *
 * @param jsonable - structure to be parsed
 * @returns parsed instance of {@link types!LangString},
 * or an error if any
 */
export function langStringFromJsonable(
  jsonable: JsonValue
): AasCommon.Either<AasTypes.LangString, DeserializationError> {
  if (jsonable === null) {
  ...
  const setter = new SetterForLangString();

  for (const key in jsonable) {
    const jsonableValue = jsonable[key];
    const setterMethod = SETTER_MAP_FOR_LANG_STRING.get(key);
    ...
    if (error !== null) {
      error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
      return new AasCommon.Either<AasTypes.LangString, DeserializationError>(
        null,
        error
      );
    }
  ...
  return new AasCommon.Either<AasTypes.LangString, DeserializationError>(
    new AasTypes.LangString(setter.language, setter.text),
    null
  );
}
...
export function levelTypeFromJsonable(
  ...
  const literal = AasStringification.levelTypeFromString(jsonable);
  if (literal === null) {
    return newDeserializationError<AasTypes.LevelType>(
      "Not a valid string representation of " + `a literal of LevelType: ${jsonable}`
    );
  }

  return new AasCommon.Either<AasTypes.LevelType, DeserializationError>(literal, null);
}
...
class SetterForDataSpecificationIec61360 {
  preferredName: Array<AasTypes.LangString> | null = null;

  shortName: Array<AasTypes.LangString> | null = null;
  ...
  definition: Array<AasTypes.LangString> | null = null;
...
/**
 * Provide de-serialize & set methods for properties
 * of {@link types!DataSpecificationPhysicalUnit}.
 */
class SetterForDataSpecificationPhysicalUnit {
  ...
  /**
   * Parse `jsonable` as the value of {@link unitName}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setUnitNameFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.unitName = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link unitSymbol}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setUnitSymbolFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.unitSymbol = parsedOrError.mustValue();
      return null;
    }
  }
  ...
  /**
   * Parse `jsonable` as the value of {@link siNotation}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setSiNotationFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.siNotation = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link siName}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setSiNameFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.siName = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link dinNotation}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setDinNotationFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.dinNotation = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link eceName}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setEceNameFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.eceName = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link eceCode}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setEceCodeFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.eceCode = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link nistName}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setNistNameFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.nistName = parsedOrError.mustValue();
      return null;
    }
  }
  ...
  /**
   * Parse `jsonable` as the value of {@link conversionFactor}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setConversionFactorFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.conversionFactor = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link registrationAuthorityId}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setRegistrationAuthorityIdFromJsonable(
    jsonable: JsonValue
  ): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      ...
      this.registrationAuthorityId = parsedOrError.mustValue();
      return null;
    }
  }

  /**
   * Parse `jsonable` as the value of {@link supplier}.
   *
   * @param jsonable - to be parsed
   * @returns error, if any
   */
  setSupplierFromJsonable(jsonable: JsonValue): DeserializationError | null {
    const parsedOrError = stringFromJsonable(jsonable);
    if (parsedOrError.error !== null) {
      return parsedOrError.error;
    } else {
      this.supplier = parsedOrError.mustValue();
      return null;
    }
  }
}
...
/**
 * Parse an instance of {@link types!DataSpecificationPhysicalUnit} from the JSON-able
 * structure `jsonable`.
 *
 * @param jsonable - structure to be parsed
 * @returns parsed instance of {@link types!DataSpecificationPhysicalUnit},
 * or an error if any
 */
export function dataSpecificationPhysicalUnitFromJsonable(
  jsonable: JsonValue
): AasCommon.Either<AasTypes.DataSpecificationPhysicalUnit, DeserializationError> {
  if (jsonable === null) {
  ...
  const setter = new SetterForDataSpecificationPhysicalUnit();

  for (const key in jsonable) {
    const jsonableValue = jsonable[key];
    const setterMethod = SETTER_MAP_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT.get(key);
    ...
    if (error !== null) {
      error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
      return new AasCommon.Either<
        AasTypes.DataSpecificationPhysicalUnit,
        DeserializationError
      >(null, error);
    }
  }

  if (setter.unitName === null) {
    return newDeserializationError<AasTypes.DataSpecificationPhysicalUnit>(
      "The required property 'unitName' is missing"
    );
  }

  if (setter.unitSymbol === null) {
    return newDeserializationError<AasTypes.DataSpecificationPhysicalUnit>(
      "The required property 'unitSymbol' is missing"
    );
  }

  if (setter.definition === null) {
    return newDeserializationError<AasTypes.DataSpecificationPhysicalUnit>(
      "The required property 'definition' is missing"
    );
  }
  ...
  return new AasCommon.Either<
    ...
    DeserializationError
  >(
    new AasTypes.DataSpecificationPhysicalUnit(
      setter.unitName,
      setter.unitSymbol,
      setter.definition,
      setter.siNotation,
      ...
      setter.registrationAuthorityId,
      setter.supplier
    ),
    null
  );
...
>([
  ...
  ["checksum", SetterForAssetAdministrationShell.prototype.setChecksumFromJsonable],
  [
    "administration",
...
>([
  ...
  ["checksum", SetterForSubmodel.prototype.setChecksumFromJsonable],
...
>([
  ...
  ["checksum", SetterForRelationshipElement.prototype.setChecksumFromJsonable],
  ["kind", SetterForRelationshipElement.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForSubmodelElementList.prototype.setChecksumFromJsonable],
  ["kind", SetterForSubmodelElementList.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForSubmodelElementCollection.prototype.setChecksumFromJsonable],
  ["kind", SetterForSubmodelElementCollection.prototype.setKindFromJsonable],
  [
    "semanticId",
...
>([
  ...
  ["checksum", SetterForProperty.prototype.setChecksumFromJsonable],
  ["kind", SetterForProperty.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForMultiLanguageProperty.prototype.setChecksumFromJsonable],
  ["kind", SetterForMultiLanguageProperty.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForRange.prototype.setChecksumFromJsonable],
  ["kind", SetterForRange.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForReferenceElement.prototype.setChecksumFromJsonable],
  ["kind", SetterForReferenceElement.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForBlob.prototype.setChecksumFromJsonable],
  ["kind", SetterForBlob.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForFile.prototype.setChecksumFromJsonable],
  ["kind", SetterForFile.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForAnnotatedRelationshipElement.prototype.setChecksumFromJsonable],
  ["kind", SetterForAnnotatedRelationshipElement.prototype.setKindFromJsonable],
  [
    "semanticId",
...
>([
  ...
  ["checksum", SetterForEntity.prototype.setChecksumFromJsonable],
  ["kind", SetterForEntity.prototype.setKindFromJsonable],
  ...
  ["specificAssetId", SetterForEntity.prototype.setSpecificAssetIdFromJsonable],
...
>([
  ...
  ["checksum", SetterForBasicEventElement.prototype.setChecksumFromJsonable],
  ["kind", SetterForBasicEventElement.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForOperation.prototype.setChecksumFromJsonable],
  ["kind", SetterForOperation.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForCapability.prototype.setChecksumFromJsonable],
  ["kind", SetterForCapability.prototype.setKindFromJsonable],
...
>([
  ...
  ["checksum", SetterForConceptDescription.prototype.setChecksumFromJsonable],
  [
    "administration",
...
const SETTER_MAP_FOR_LANG_STRING = new Map<
  string,
  (jsonable: JsonValue) => DeserializationError | null
>([
  ["language", SetterForLangString.prototype.setLanguageFromJsonable],
  ["text", SetterForLangString.prototype.setTextFromJsonable],
  ["modelType", SetterForLangString.prototype.ignore]
]);
...
>([
  ...
  ["DataSpecificationPhysicalUnit", dataSpecificationPhysicalUnitFromJsonable]
]);
...
const SETTER_MAP_FOR_DATA_SPECIFICATION_PHYSICAL_UNIT = new Map<
  string,
  (jsonable: JsonValue) => DeserializationError | null
>([
  [
    "unitName",
    SetterForDataSpecificationPhysicalUnit.prototype.setUnitNameFromJsonable
  ],
  [
    "unitSymbol",
    SetterForDataSpecificationPhysicalUnit.prototype.setUnitSymbolFromJsonable
  ],
  [
    "definition",
    SetterForDataSpecificationPhysicalUnit.prototype.setDefinitionFromJsonable
  ],
  [
    "siNotation",
    SetterForDataSpecificationPhysicalUnit.prototype.setSiNotationFromJsonable
  ],
  ["siName", SetterForDataSpecificationPhysicalUnit.prototype.setSiNameFromJsonable],
  [
    "dinNotation",
    SetterForDataSpecificationPhysicalUnit.prototype.setDinNotationFromJsonable
  ],
  ["eceName", SetterForDataSpecificationPhysicalUnit.prototype.setEceNameFromJsonable],
  ["eceCode", SetterForDataSpecificationPhysicalUnit.prototype.setEceCodeFromJsonable],
  [
    "nistName",
    SetterForDataSpecificationPhysicalUnit.prototype.setNistNameFromJsonable
  ],
  [
    "sourceOfDefinition",
    SetterForDataSpecificationPhysicalUnit.prototype.setSourceOfDefinitionFromJsonable
  ],
  [
    "conversionFactor",
    SetterForDataSpecificationPhysicalUnit.prototype.setConversionFactorFromJsonable
  ],
  [
    "registrationAuthorityId",
    SetterForDataSpecificationPhysicalUnit.prototype
      .setRegistrationAuthorityIdFromJsonable
  ],
  [
    "supplier",
    SetterForDataSpecificationPhysicalUnit.prototype.setSupplierFromJsonable
  ],
  ["modelType", SetterForDataSpecificationPhysicalUnit.prototype.ignore]
]);
...
class Serializer extends AasTypes.AbstractTransformer<JsonObject> {
  ...
  transformExtension(that: AasTypes.Extension): JsonObject {
    ...
    if (that.refersTo !== null) {
      jsonable["refersTo"] = this.transform(that.refersTo);
    }
  ...
  transformAssetAdministrationShell(
    ...
    if (that.checksum !== null) {
      jsonable["checksum"] = that.checksum;
    }
  ...
  transformAssetInformation(that: AasTypes.AssetInformation): JsonObject {
    ...
    if (that.globalAssetId !== null) {
      jsonable["globalAssetId"] = this.transform(that.globalAssetId);
    }
  ...
  transformSubmodel(that: AasTypes.Submodel): JsonObject {
    ...
    if (that.kind !== null) {
      jsonable["kind"] = AasStringification.mustModelingKindToString(that.kind);
    }
  ...
  transformEntity(that: AasTypes.Entity): JsonObject {
    ...
    if (that.specificAssetId !== null) {
      jsonable["specificAssetId"] = this.transform(that.specificAssetId);
    }
   ...
   * @returns JSON-able representation
   */
  transformLangString(that: AasTypes.LangString): JsonObject {
    const jsonable: JsonObject = {};
  ...
  transformDataSpecificationIec61360(
    ...
    if (that.levelType !== null) {
      jsonable["levelType"] = AasStringification.mustLevelTypeToString(that.levelType);
    }
  ...
  transformDataSpecificationPhysicalUnit(
    that: AasTypes.DataSpecificationPhysicalUnit
  ): JsonObject {
    const jsonable: JsonObject = {};

    jsonable["unitName"] = that.unitName;

    jsonable["unitSymbol"] = that.unitSymbol;
    ...
    if (that.siNotation !== null) {
      jsonable["siNotation"] = that.siNotation;
    }

    if (that.siName !== null) {
      jsonable["siName"] = that.siName;
    }

    if (that.dinNotation !== null) {
      jsonable["dinNotation"] = that.dinNotation;
    }

    if (that.eceName !== null) {
      jsonable["eceName"] = that.eceName;
    }

    if (that.eceCode !== null) {
      jsonable["eceCode"] = that.eceCode;
    }

    if (that.nistName !== null) {
      jsonable["nistName"] = that.nistName;
    }
    ...
    if (that.conversionFactor !== null) {
      jsonable["conversionFactor"] = that.conversionFactor;
    }

    if (that.registrationAuthorityId !== null) {
      jsonable["registrationAuthorityId"] = that.registrationAuthorityId;
    }

    if (that.supplier !== null) {
      jsonable["supplier"] = that.supplier;
    }

    jsonable["modelType"] = "DataSpecificationPhysicalUnit";
